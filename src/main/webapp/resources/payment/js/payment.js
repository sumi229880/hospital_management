			...
			.createToken(
					...
					function stripeResponseHandler(status, response) {
						if (response.error) {
							...
							// AJAX - you would send 'token' to your server
							// here.
							$
									.post('/account/stripe_card_token', {
										token : token
									})
									// Assign handlers immediately after making
									// the request,
									.done(
...
validator = $form.validate({
	...
	highlight : function(element) {
		$(element).closest('.form-control').removeClass('success').addClass(
				'error');
	},
