                ...
                <form class="form-horizontal" action='registerEvent.htm'
						...
						<div class="group" style="margin-bottom:0px;">
							...
							<label></label> <textarea type="text"
								name="details" placeholder="${events.details}" rows="5" cols="90" disabled></textarea> <span
								class="highlight"></span> <span class="bar"></span>
						</div>

						<div class="group" style="margin-bottom:0px;">
							<p><strong>Requirements</strong></p>
							<label></label> <textarea type="text" name="requirement" rows="5" cols="90" placeholder="${events.requirement}" disabled></textarea>
							<span class="highlight"></span> <span class="bar"></span>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" action = "bookAppointment.htm?action=book" method = "POST">
                                        ...
                                        <div class="form-group">
  											...
  											<div class="col-sm-10">
										  	<input class="form-control"  id="reason" name="reason" placeholder = "Enter Reason ..."></input>
										  	</div>
										</div>
